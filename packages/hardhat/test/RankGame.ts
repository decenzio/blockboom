...
import type { RankGame } from "../typechain-types";

describe("RankGame", function () {
  let game: RankGame;

  beforeEach(async () => {
    const factory = await ethers.getContractFactory("RankGame");
    game = (await factory.deploy()) as unknown as RankGame;
