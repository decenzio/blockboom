 ...
 */
export const APP_NAME: string = 'rankr';

/**
 * A brief description of the mini app's functionality.
 * Used in app store listings and metadata.
 */
export const APP_DESCRIPTION: string = 'a ranking app with friends!';
 ...
 */
export const APP_TAGS: string[] = ['social', 'games', 'media', 'prizes'];
 ...
 */
export const APP_BUTTON_TEXT: string = 'Start Ranking! 🚀';
